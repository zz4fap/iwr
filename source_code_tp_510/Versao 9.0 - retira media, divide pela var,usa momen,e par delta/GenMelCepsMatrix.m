function [MelCepsMatrixTreinamento, matriztreinamento, MelCepsMatrixTeste, matrizteste]=GenMelCepsMatrix(ordem,Fs,nQuadrosAdjacentes)
...
[MelCepsMatrixTreinamento, matriztreinamento]=GenMelCepsMatrixTreinamento(ordem,Fs,nQuadrosAdjacentes);
[MelCepsMatrixTeste,matrizteste]=GenMelCepsMatrixTeste(ordem,Fs,nQuadrosAdjacentes);
...
MatrixTreinamento=zeros(1440,nLocucoes);
for j=1:nLocucoes
    for m=1:60
        for n=1:ordem
            MatrixTreinamento((ordem*(m-1))+n,j)=MelCepsMatrixTreinamento(n,(60*(j-1))+m);
        end
    end
end
...
MatrixTeste=zeros(1440,nLocucoes);
for j=1:nLocucoes
    for m=1:60
        for n=1:ordem
            MatrixTeste((ordem*(m-1))+n,j)=MelCepsMatrixTeste(n,(60*(j-1))+m);
        end
    end
end
...
MelCepsMatrixTreinamento=MelCepsMatrixTreinamento/desvio;
MelCepsMatrixTeste=MelCepsMatrixTeste/desvio;
