...
nEntradas=300;           % Número de sinais de entrada
...
% % Carrega parametros .mel para teste e treinamento sem normalizacao. 
% load PLPMatrixTreinamento.mat;  
% load PLPMatrixTeste.mat;  

% Carrega parametros .mel para teste e treinamento com normalizacao.
load PLPMatrixNormalizadoTreinamento.mat;
load PLPMatrixNormalizadoTeste.mat;  

nEpocas=300;                 % Numero de epocas
