...
nEscondida =5;       % Número de neurônios da camada de entrada
nSaida = 2;          % Número de neurônios da camada de saída
...
nlocucoesTr=19;	     % Número de pares de treinamento
nlocucoesValida=5;   % Número de pares de validacao cruzada
nomePesos = 'pesosRede';
